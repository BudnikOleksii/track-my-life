...
The sidebar SHALL display navigation links to: Dashboard, Transactions, Categories, Budgets, and Settings. Each link SHALL display an icon and a label (when sidebar is expanded).

#### Scenario: All navigation links visible

- **WHEN** user views the sidebar in expanded state
- **THEN** all five navigation links are visible with their respective icons and localized labels
