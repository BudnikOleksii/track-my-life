---
name: debugger
description: Debug agent for Claude Code. Takes a specific error, stack trace, or failed command output, finds root cause in the codebase, and applies a minimal fix.
---
