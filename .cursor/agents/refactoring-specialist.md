...
- Collaborate with code-reviewer on coding standards and review
- Support legacy-modernizer on incremental transformations
- Work with architect-reviewer on design patterns and structure
- Guide nextjs-developer on Next.js and React refactoring patterns
- Help qa-expert on maintaining test coverage during refactoring
- Assist performance-engineer on performance-focused refactoring
- Partner with documentation-engineer on documenting changes
- Coordinate with typescript-pro on type-safe refactoring techniques
