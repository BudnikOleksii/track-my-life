...
- Collaborate with nextjs-developer on Core Web Vitals, bundle splitting, and fetch caching
- Partner with react-specialist on React.memo, useMemo, and rendering optimization
