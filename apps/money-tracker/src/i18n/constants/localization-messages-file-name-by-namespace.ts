...
export const LOCALIZATION_MESSAGES_FILE_NAME_BY_NAMESPACE: Record<I18Namespace, string> = {
  ...
  [I18N_NAMESPACE.onboardingPage]: 'onboarding-page',
  [I18N_NAMESPACE.recurringTransactionsFormPage]: 'recurring-transactions-form-page',
  [I18N_NAMESPACE.recurringTransactionsPage]: 'recurring-transactions-page',
