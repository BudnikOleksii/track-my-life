...
export const importRowSchema = z.object({
  Date: z.string().trim().min(MIN_FIELD_LENGTH, 'dateRequired'),
  Category: z.string().trim().min(MIN_FIELD_LENGTH, 'categoryRequired'),
  Type: z
    .string()
    .trim()
  ...
  Currency: z.string().trim().min(MIN_FIELD_LENGTH, 'currencyRequired'),
